...
if [ -z "$APP_NAME" ] || { [ "$APP_NAME" != "main" ] && [ "$APP_NAME" != "quicksight-access" ] && [ "$APP_NAME" != "sustainability" ]; }; then
  echo "App name must be provided and be one of 'main' or 'quicksight-access' or 'sustainability"
