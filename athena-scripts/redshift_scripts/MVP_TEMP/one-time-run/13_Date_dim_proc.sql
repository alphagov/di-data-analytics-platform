CREATE OR REPLACE PROCEDURE prod_conformed.redshift_date_dim(v_start_date character varying(20), v_end_date character varying(20))
 LANGUAGE plpgsql
AS $$
BEGIN
    DECLARE
    ...
    end_date := v_end_date;
        ...
        WHILE start_date <= end_date LOOP
            ...
            insert into prod_conformed.DIM_DATE(DATE_KEY,DATE,DAY,DAY_SUFFIX,WEEKDAY,WEEKDAY_NAME,weekday_name_short,DAY_OF_WEEK_IN_MONTH,
...
--call dev_conformed.redshift_date_dim('2022-08-01','2022-09-01')