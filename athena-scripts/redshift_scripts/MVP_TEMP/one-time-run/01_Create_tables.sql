CREATE TABLE dev_conformed.BatchControl (
...
CREATE TABLE dev_conformed.DIM_EVENT (
...
CREATE TABLE dev_conformed.DIM_DATE (
DATE_KEY INT ,
DATE DATE ,
DAY VARCHAR(50),
...
CREATE TABLE dev_conformed.DIM_JOURNEY_CHANNEL(
...
CREATE TABLE dev_conformed.DIM_RELYING_PARTY (
...
CREATE TABLE dev_conformed.DIM_VERIFICATION_ROUTE(
...
CREATE TABLE dev_conformed.FACT_USER_JOURNEY_EVENT(
...
BATCH_ID INTEGER,
    ...
    FOREIGN KEY (EVENT_KEY) REFERENCES dev_conformed.DIM_EVENT (EVENT_KEY),
    FOREIGN KEY (DATE_KEY) REFERENCES dev_conformed.DIM_DATE (DATE_KEY),
    FOREIGN KEY (VERIFICATION_ROUTE_KEY) REFERENCES dev_conformed.DIM_VERIFICATION_ROUTE (VERIFICATION_ROUTE_KEY),
    FOREIGN KEY (JOURNEY_CHANNEL_KEY) REFERENCES dev_conformed.DIM_JOURNEY_CHANNEL (JOURNEY_CHANNEL_KEY),
    FOREIGN KEY (RELYING_PARTY_KEY) REFERENCES dev_conformed.DIM_RELYING_PARTY (RELYING_PARTY_KEY)
);


CREATE TABLE dev_conformed.REF_EVENTS (
...
CREATE TABLE dev_conformed.REF_RELYING_PARTIES (
